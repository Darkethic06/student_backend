...
class AuthController extends BaseController
{
     ...
     *            @OA\Schema(
     *               type="object",
     *               required={"student_code", "password"},
    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            if (is_null($user)) {
                return $this->sendError('Failed! Student Code not found', [], 404);
            }

            if (Auth::attempt(['student_code' => $request->student_code, 'password' => $request->password])) {
