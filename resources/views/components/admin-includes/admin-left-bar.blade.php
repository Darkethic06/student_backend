    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="{{ route('admin.dashboard') }}" class="logo_text_custom">
                {{-- <img src="{{ asset('laravel10 _logo.png') }}" alt="" width="75%" style="padding: 10px"> --}}
                Student MS
            </a>
        </div>
        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Student Management</h4>
                ...
                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Class Management</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2">

                    </i>
                </li>

                <li class="kt-menu__item  {{ Request::is('admin/student-class*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('student-class.index') }}" class="kt-menu__link ">
                        <i class="kt-menu__link-icon fa fa-users"></i>
                        <span class="kt-menu__link-text">All Class</span>
                    </a>
                </li>
                ...
                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Teacher Management</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2">

                    </i>
                </li>

                <li class="kt-menu__item  {{ Request::is('admin/teachers*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                ...
                <li class="kt-menu__item  {{ Request::is('admin/assign-teacher*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('assign-teacher.index') }}" class="kt-menu__link ">
                        <i class="kt-menu__link-icon fa fa-users"></i>
                        <span class="kt-menu__link-text">Assign Class</span>
                    </a>
                </li>

                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Subject Management</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2">

                    </i>
                </li>

                <li class="kt-menu__item  {{ Request::is('admin/subject*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('subject.index') }}" class="kt-menu__link ">
                        <i class="kt-menu__link-icon fa fa-users"></i>
                        <span class="kt-menu__link-text">All Subject</span>
                    </a>
                </li>

                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Notice Management</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2">
                    </i>
                </li>

                <li class="kt-menu__item  {{ Request::is('admin/notice*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('notice.index') }}" class="kt-menu__link ">
                        <i class="kt-menu__link-icon fa fa-users"></i>
                ...
                {{-- <li class="kt-menu__item  {{ Request::is('admin/cms*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('cms.index') }}" class="kt-menu__link ">
                        <i class="kt-menu__link-icon flaticon-imac"></i>
                        <span class="kt-menu__link-text">CMS</span>
                    </a>
                </li> --}}

                {{-- <li class="kt-menu__item  {{ Request::is('admin/faq*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true">
