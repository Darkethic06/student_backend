    ...
    <x-slot name="tbody">
        @forelse($teachers as $user)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('teachers.edit', ['teacher' => $user->id]) }}"><i
        ...
        {{-- <tr>
                    ...
                    <x-admin.td-action>
                        <a class="dropdown-item" href="{{route('teachers.edit', ['user' => $user->id])}}" ><i class="la la-edit"></i> Edit</a>
